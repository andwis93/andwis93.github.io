$(document).ready(function() {
  const apiRoot = 'https://kodilla-tasks-prod-kodilla-tasks-brsg0g.mo6.mogenius.io//v1/tasks';
  const trelloApiRoot = 'https://kodilla-tasks-prod-kodilla-tasks-brsg0g.mo6.mogenius.io/v1/trello';
